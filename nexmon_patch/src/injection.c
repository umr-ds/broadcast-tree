...
wl_send_hook(struct hndrte_dev *src, struct hndrte_dev *dev, struct sk_buff *p)
{
    /**
     * TODO
     * This hook is needed after the construction phase, for data sending phase.
     * The design itself is not done yet. Quick idea: send packets using UDP
     * socket on defined port. We then intercept them here and pack them into
     * BTP packets. The receiving node will unpack again, put into UDP packet
     * and forward it to the userland.
    **/
